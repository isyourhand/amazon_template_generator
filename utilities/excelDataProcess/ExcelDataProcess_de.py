...
def copy_data_de(target_file_path, source_file_path, prefix, 
    ...
    try:
        ...
        for i, item in enumerate(data, start=4):
            ...
            price_with_margin = calculate_Price(price_Hash["德国"], shipping_cost, profit)
            ...
            _color_ = item["颜色"] if item["颜色"].lower() not in de_color_Map else de_color_Map[item["颜色"].lower()]
            _color_map_ = item["颜色"] if item["颜色"].lower() not in de_color_map_Map else de_color_map_Map[item["颜色"].lower()]
            size_class = "Alphanumerisch" if not has_numbers(item['尺寸']) else "Alter"
            ...
            target_sheet.cell(row=i, column=column_indices["language_value1"], value="Englisch")
            ...
            target_sheet.cell(row=i, column=column_indices["care_instructions"], value="Maschinelle Wäsche oder Handwäsche")
            ...
            target_sheet.cell(row=i, column=column_indices["is_autographed"], value="Nein")
            ...
            special_features = [
                "Atmungsaktiv", "Leichtgewichtig", "Sonnenschutz", "Absorbierend", "Dehnbar", "Konvertierbar", "Verstellbar"
            ]
            ...
            target_sheet.cell(row=i, column=column_indices["material_type1"], value="Baumwolle")
            ...
            target_sheet.cell(row=i, column=column_indices["material_type2"], value="Fell")
            ...
            target_sheet.cell(row=i, column=column_indices["condition_type"], value="Neu")
            ...
            if contains_alpha:  # Child
                ...
                target_sheet.cell(row=i, column=column_indices["apparel_size_system"], value="DE / NL / SE / PL")
                ...
                target_sheet.cell(row=i, column=column_indices["shirt_size_system"], value="DE / NL / SE / PL")
                ...
                target_sheet.cell(row=i, column=column_indices["bottoms_size_system"], value="DE / NL / SE / PL")
                ...
                target_sheet.cell(row=i, column=column_indices["skirt_size_system"], value="DE / NL / SE / PL")
                ...
                target_sheet.cell(row=i, column=column_indices["shapewear_size_system"], value="DE / NL / SE / PL")
