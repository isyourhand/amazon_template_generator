...
def copy_data_uk(target_file_path, source_file_path, prefix, 
    ...
    try:
        ...
        for i, item in enumerate(data, start=4):
            ...
            # Other
            target_sheet.cell(row=i, column=column_indices["special_features5"], value=special_features5_random())
            ...
            target_sheet.cell(row=i, column=column_indices["currency"], value="GBP")
            target_sheet.cell(row=i, column=column_indices["language_value1"], value="English")
            ...
            target_sheet.cell(row=i, column=column_indices["water_resistance_level"], value="Water Resistant")
            ...
            # 定义所有的 lifestyle 类型
            lifestyle_types = [
                "Business", "Casual", "Ceremony", "Evening", "Kids Playwear", "Dress", "Work Utility", "Athletic", "Uniform", "Maternity","Nursing","Themed","Exotic"
            ]
            ...
            special_features = [
                "Breathable", "Lightweight", "Moisture Wicking", "Quick Dry"
            ]
            ...
            target_sheet.cell(row=i, column=column_indices["seasons"], value=random.choice(["Autumn-Winter","Spring-Summer"]))
            ...
            if contains_alpha:  # Child
                ...
                target_sheet.cell(row=i, column=column_indices["apparel_size"], value=size_map)
                target_sheet.cell(row=i, column=column_indices["shirt_size"], value=size_map)
                target_sheet.cell(row=i, column=column_indices["bottoms_size"], value=size_map)
                target_sheet.cell(row=i, column=column_indices["skirt_size"], value=size_map)
                ...
                target_sheet.cell(row=i, column=column_indices["skirt_size_system"], value=site_Map[site])
                ...
                target_sheet.cell(row=i, column=column_indices["shapewear_size_system"], value=site_Map[site])
                target_sheet.cell(row=i, column=column_indices["shapewear_size_class"], value=size_class)
                target_sheet.cell(row=i, column=column_indices["shapewear_size"], value=size_map)
